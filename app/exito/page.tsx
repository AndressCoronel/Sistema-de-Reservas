    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      <main className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-900/30 rounded-2xl p-5 mb-8">
            <h3 className="font-bold text-yellow-800 dark:text-yellow-200 mb-2">Importante</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-yellow-400 text-zinc-900 font-bold rounded-lg hover:bg-yellow-500 transition-colors"
            >
              Hacer Otra Reserva
            </button>
          </div>
